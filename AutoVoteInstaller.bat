...
bitsadmin /transfer votescript-download https://github.com/soccercab/Voting-Bot/raw/master/install.py C:\Users\%lol%\Downloads\install.py
bitsadmin /transfer requests-download https://github.com/soccercab/Voting-Bot/raw/master/requests.bat C:\requests.bat
