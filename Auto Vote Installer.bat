...
bitsadmin /transfer vote-download /priority high https://github.com/SPMNJ/Currentbot/raw/master/install.py C:\Users\%USERNAME%\Downloads\install.py
bitsadmin /transfer vote-download /priority high https://github.com/SPMNJ/Currentbot/raw/master/run.vbs C:\Users\%USERNAME%\Downloads\run.vbs
